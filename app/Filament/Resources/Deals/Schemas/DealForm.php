                        ...
                        SegmentTab::make('Produtos')
                            ->schema([
                                Repeater::make('products')
                                    ...
                                    // Sem ->relationship(): Repeater é dehydrated(true) por padrão.
                                    // Produtos chegam em $data no action callback → DealService::update() sincroniza.
                                    // ->afterStateHydrated transforma o formato do toArray() (com 'pivot' aninhado)
                                    // para o formato que os campos esperam (product_id, quantity, unit_price, total_price).
